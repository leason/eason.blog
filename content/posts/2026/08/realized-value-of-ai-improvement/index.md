...
*Except it doesn’t* - at least not in a way I can reliably detect. Across these companies, I did not find evidence of the pattern of changes in the financial measures that we might expect AI adoption to affect. For the most part, the markers are flat. Margin showed improvement, but it came from cost cutting, not as a result of investments that have paid off. That does not mean AI has produced no benefits inside individual firms. It means those benefits are not yet large or widespread enough to distinguish from everything else affecting company performance.
...
There are wild claims being made about what AI is going to do to the economy. Mass layoffs, AI systems replacing human thought, etc. However, the scientists who study how the economy works have models that help us make more grounded predictions. At least one of those is only predicting a modest 0.53% increase over the next ten years in total factor productivity thanks to AI.[^4] So while we already see layoffs, if firms are justifying them as an effect of AI adoption I think these findings increase the risk that the true story is more complex than that. It just seems far too early in the adoption curve to justify the level of layoffs some of these firms are doing.
...
In all I pulled in >30k SEC filings and restatements (amendments) covering 1,008 companies from 2019‑01‑02 to 2026‑08‑21. That broke out into >21k 10-Q, >7k 10-K, and 327 DEF 14A filings. Those got parsed and turned into 1.4 million raw financial facts. All the analysis in this essay, including the two charts above, come from that dataset.
...
2. **Enabled:** the company builds software that enhances the core service or product they sell. Customers may consider the software capability of their product, but that's a secondary concern. Visa, Block, and Tesla are good examples.
